...
func tryRefreshModels(ctx context.Context, label string) {
	...
	// If the remote catalog omits optional sections that the embedded catalog
	// provides, fall back to the existing data for those sections so that
	// providers not yet published to the remote registry continue to work.
